                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 field modal__field modal__field-col">
                                        <?php $label = Yii::t('policy', 'Позиция'); ?>
                                        <?= $form->field($model, "appl_orgname", ['options' => ['class' => 'form-group']])->textInput( [
                                            'type' => 'text',
                                            'multiple' => false,
                                            'readonly' => false,
                                            'maximumSelectionLength' => 1,
                            ...
                            <div class="col-12 owner-region-info">
                                <div class="row">
                                    <div class="col-md-6 col-12 ">
                                        ...
                                        <?= $form->field($model, "region_id", ['options' => ['class' => 'form-group']])->dropDownList(HandbookFondRegion::_getItemsListByInsParam(), [
                                            'multiple' => false,
                                            'maximumSelectionLength' => 1,
                                    ...
                                    <div class="col-md-6 col-12 ">
                                        <?php $label = Yii::t('policy', 'Имя представителя'); ?>
                                        <?= $form->field($model, "owner_first_name", ['options' => ['class' => 'form-group']])->textInput( [
                                             'type' => 'text',
                                            'class' => 'field__input form-control',
                                            'prompt' => Yii::t('policy', 'Выберите'),
                                        ])->label($label, ['class' => 'control-label main-form-label my-2']) ?>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12 owner-pensioner-info">
                                                <?php $label = Yii::t('policy', 'Расчетный счет'); ?>
                                                <?= $form->field($model, 'checking_account', ['options' => ['class' => 'form-group']])
                                                    ->textInput(['type' => 'text',
                                                        'maxlength' => 18,
//                                                        'readonly' => !empty($model->policy_series) ? $model->policy_series : false,
                                                        'autocomplete' => 'off',
//                                                        'autofocus' => empty($model->policy_series),
                                                        'class' => 'field__input form-control',
                                                        'oninput' => 'this.value = this.value.toUpperCase()',
                                                        'placeholder' => Yii::t('policy', '123456789'),
                                                    ])->label($label, ['class' => 'control-label main-form-label d-block my-2']) ?>
                                            </div>
                                        </div>
                                    </div>
