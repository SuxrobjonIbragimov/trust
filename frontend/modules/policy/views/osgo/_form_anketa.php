    ...
    <div class="row custom-row--lg mb-3">
        <div class="col-lg-8 col-12">
            ...
            <div class="calculator-group">
                <!--<h3 class="main-title-sm text-uppercase h5
                 fw-bold"><?/*= Yii::t('policy', 'Fill in personal information'); */?></h3>-->
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                            ...
                            <div class="col-md-6 col-sm-6 col-12">
                                <div class="row series-number-row align-items-start justify-content-between">
                                    ...
                                    <div class="col-xl-5 col-md-5 col-5">
                                        ...
                                        ])->label('label', ['class' => 'control-label invisible  my-2']) ?>
                                    </div>
                                    <div class="col-xl-3 col-md-3 col-3">
                                        <label class="control-label invisible  my-2">label</label>
                                        <button type="button" id="check-vehicle"
                                                class="check-button btn anketa__check btn d-flex align-items-center justify-content-center ms-auto fill-white <?= ($model->isNewRecord) ? 'check btn-success padding-for-button' : 'clear padding-for-button' ?>">
                        ...
                        <div id="vehicle-info"
                            ...
                            <div class="col-12">
                                <div class="row">
                                    ...
                                    <?php echo Html::activeHiddenInput($model, "driver_limit_id"); ?>
                                </div>
                        ...
                        <div class="row mt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="row justify-content-between">
                                                    <div class="col-md-6 col-12 series-two-things">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        ...
                                                        echo Html::hiddenInput('owner_address', $model->app_address, ['id' => 'owner_address']);
                            ...
                            <div id="applicant-info" class="<?= ($model->owner_is_applicant || $model->isNewRecord) ? 'd-none' : ''; ?> mt-4">
                                    ...
                                    <div class="row align-start">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="row align-start justify-space-between">
                                                <div class="col-4 series-two-things">
                                                ...
                                                <div class="col-3">
                                                    ...
                                                    <button type="button" id="check-applicant"
                                                            class="anketa__check s-custom-btn s-custom-primary btn--md s-custom-btn--icon ms-auto text-capitalize check-button btn d-flex align-items-center justify-content-center fill-white <?= ($model->isNewRecord) ? 'check btn-success padding-for-button' : 'clear padding-for-button' ?>">
                                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                             xmlns="http://www.w3.org/2000/svg" class="check-icon">
                                                            <path fill-rule="evenodd" clip-rule="evenodd"
                                                                  d="M3.33366 9.16675C3.33366 5.94509 5.94533 3.33341 9.16699 3.33341C12.3887 3.33341 15.0003 5.94509 15.0003 9.16675C15.0003 10.7384 14.3788 12.1648 13.3682 13.2137C13.3396 13.2357 13.3122 13.2597 13.2861 13.2858C13.2599 13.312 13.2359 13.3394 13.214 13.3679C12.1651 14.3786 10.7386 15.0001 9.16699 15.0001C5.94533 15.0001 3.33366 12.3884 3.33366 9.16675ZM13.8484 15.0267C12.5653 16.053 10.9378 16.6667 9.16699 16.6667C5.02486 16.6667 1.66699 13.3089 1.66699 9.16675C1.66699 5.02461 5.02486 1.66675 9.16699 1.66675C13.3091 1.66675 16.667 5.02461 16.667 9.16675C16.667 10.9376 16.0533 12.5651 15.0269 13.8482L18.0896 16.9108C18.415 17.2363 18.415 17.7639 18.0896 18.0893C17.7641 18.4148 17.2365 18.4148 16.9111 18.0893L13.8484 15.0267Z"
                            ...
                            <div id="driver-info" class="<?= (((empty($model->policyOsgoDrivers)) && $model->isNewRecord)) ? 'd-none' : ''; ?>">
                            ...
                            <div class="container-items-driver">
                                ...
                                foreach ($modelDrivers as $i => $modelItem): ?>
                                    <div class="item-driver panel panel-default driver-index-<?= $i ?>"
                                        ...
                                        <div class="panel-heading p-relative my-3 position-relative">
                                            ...
                                            <div class="pull-right page-footer-button">
                                                <button type="button" class="remove-item-driver btn btn-secondary btn-xs" title="<?= Yii::t('policy', 'Delete') ?>">-</button>
                                            </div>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-12 col-12 ">
                                                    <div class="row series-number-row align-items-start justify-content-between">
                                                        ...
                                                        <div class="col-2 series-two-things">
                                                        ...
                                                        <div class="col-2">
                                                            <label class="control-label invisible  my-2">label</label>
                                                            <button type="button"
                                                                    class="check-driver check-button btn anketa__check s-custom-btn s-custom-primary ms-auto ms-auto btn--md s-custom-btn--icon text-capitalize d-flex align-items-center justify-content-center fill-white check-driver-index-<?= $i ?> btn <?= ($modelItem->isNewRecord) ? 'check btn-success padding-for-button' : 'clear padding-for-button' ?>"
                                                                    data-index="<?= $i ?>">
                                            ...
                                            <div class="row driver-license-info license-block <?= ($modelItem->isNewRecord) ? 'd-none' : ''; ?>">
                                                ...
                                                <div class="col-5 field">
                                                    <div class="row series-number-row-without-btn justify-space-between align-start">
                                                        <div class="col-4 series-two-things">
                            ...
                            <div class="pull-right- page-footer-button">
                                <button type="button" class="add-item-driver btn btn-secondary btn-xs my-3">
        ...
        <div class="col-12">
                        ...
                        <div class="">
                            <div class="page-footer-button">
                                <div class="form-group">
                                    <?= Html::submitButton(Yii::t('policy', 'Перейти к просмотру'), ['class' => 'btn btn-success btn-xs s-custom-btn s-custom-primary s-custom-btn--icon text-capitalize mt-5 mb-5 btn btn-success']) ?>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <input type="hidden" id="label_driver" value="<?= ($model->driver_limit_id == PolicyOsgo::DRIVER_LIMITED) ? Yii::t('policy', 'Водитель') : Yii::t('policy', 'Родственник'); ?>">
