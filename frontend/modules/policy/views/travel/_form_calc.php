...
<?php Pjax::begin(['id' => 'pjax_policy_travel_calc']); ?>
    ...
    <div class="row custom-row--lg mb-3 form__calc">
        <div class="col-lg-8 col-12">

            <div class="calculator-group">
                <div class="row custom-row--sm">
                    <div class="col-12">
                        <h4 class="contact-us-page__label mb-0 text-bold"><?= Yii::t('policy', 'Детали путешествия') ?></h4>
                    </div>
                    <div class="col-12">
                        <div class="row custom-row--sm">
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-7 col-12">
                                ...
                                <div class="row custom-row--sm">
                                    <div class="<?= ($model->isMulti()) ? 'col-md-5' : ''; ?> col-12">
                                ...
                                <?php if (!empty($model->_travelProgramsList)):?>
                                    <div class="form-group my-2">
                                        ...
                                        <?= $form->field($model, 'program_id')->radioList($model->_travelProgramsList, [
                                            'class' => 'form-control flex-column on-change id-custom gy-1',
                                                        ...
                                                        <ul class="">
                                                            ...
                                                            <?php foreach ($program_info as $key => $value): ?>
                                                                <?php if (!empty($program_labels[$key])) :?>
                                                                    <li class="">
                                                                        <p class="flex flex-row flex-aligin-center flex-space-between fs-4" style="    justify-content: space-between;">
                        ...
                        <div class="row custom-row--sm">
                            <div class="col-12">
                                ...
                                <?= $form->field($model, 'purpose_id')->radioList($model->_travelPurposesList, [
                                    'class' => 'form-control on-change form-custom d-flex flex-wrap gy-1',
                        ...
                        <div class="programs-block">
                            ...
                            <?php if ($model->is_family):?>
                                ...
                                <div class="container-items-parent"><!-- widgetContainer -->
                                    <?php foreach ($modelParentTravellers as $i => $modelItem): ?>
                                        <div class="item-parent panel panel-default"><!-- widgetBody -->
                                            <div class="panel-heading p-relative">
                                                <h3 class="panel-title pull-left panel-title-birthday contact-us-page__label"><?=Yii::t('policy','Parent <span class="index">{0}</span>',[$i+1])?></h3>
                                                <div class="pull-right page-footer-button">
                                                    <button type="button" class="remove-item-parent btn btn-danger btn-xs">-</button>
                                                </div>
                                                ...
                                                <div class="row custom-row--sm align-start">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="row custom-row--sm align-start justify-space-between">
                                                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 series-two-things">
                                                            ...
                                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 series-num-middle"><!--series-two-things-right-auto"-->
                                                            ...
                                                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 btn-series">
                                                                <label class="invisible main-form-label">hide</label>
                                                                <button type="button"
                                                                        class="check-traveller check-button btn anketa__check s-custom-btn s-custom-primary ms-auto btn--md s-custom-btn--icon text-capitalize <?= ($i == 0 || !$model->isNewRecord) ? 'check-travelparent-index-'.$i : '' ?> btn <?= ($modelItem->isNewRecord) ? 'check' : 'clear' ?>"
                                                                        data-index="<?= $i ?>" data-param="travelparent">
                                ...
                                <div class="pull-right-page-footer-button">
                                    <button type="button" class="add-item-parent <?= (count($modelParentTravellers) < 2) ? '' : 'd-none'?> btn btn-success btn-xs s-custom-btn s-custom-primary s-custom-btn--icon mt-5 mb-5"><?=Yii::t('policy','Add parent')?></button>
                                </div>
                                ...
                                <div class="container-items-child"><!-- widgetContainer -->
                                    <?php foreach ($modelTravellers as $i => $modelItem): ?>
                                        <div class="item-child panel panel-default"><!-- widgetBody -->
                                            <div class="panel-heading p-relative">
                                                <h3 class="panel-title pull-left panel-title-birthday contact-us-page__label"><?=Yii::t('policy','Child <span class="index">{0}</span>',[$i+1])?></h3>
                                                <div class="pull-right page-footer-button">
                                                    <button type="button" class="remove-item-child btn btn-danger btn-xs">-</button>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                            <div class="panel-body">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="row custom-row--sm align-start justify-space-between">
                                                            ...
                                                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 btn-series">
                                                                <label class="invisible main-form-label">hide</label>
                                                                <button type="button"
                                                                        class="check-traveller check-button btn anketa__check s-custom-btn s-custom-primary ms-auto btn--md s-custom-btn--icon text-capitalize <?= ($i == 0 || !$model->isNewRecord) ? 'check-travel-index-'.$i : '' ?>  btn <?= ($modelItem->isNewRecord) ? 'check' : 'clear' ?>"
                                ...
                                <div class="pull-right-page-footer-button">
                                    <button type="button" class="add-item-child <?= (count($modelParentTravellers) + count($modelTravellers) >= 6) ? 'd-none' : ''?> btn btn-success btn-xs s-custom-btn s-custom-primary s-custom-btn--icon mt-5 mb-5"><?=Yii::t('policy','Add child')?></button>
                                </div>
                                <?php DynamicFormWidget::end(); ?>
                            ...
                            <?php else:?>
                                ...
                                <div class="row custom-row--sm align-start">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="row custom-row--sm align-start justify-space-between">
                                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-4 col-4 series-two-things">
                                            ...
                                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-6 col-6 series-num-middle"><!--series-two-things-right-auto"-->
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-2 btn-series">
                                                ...
                                                <button type="button" id="check-applicant"
                                                        class="anketa__check s-custom-btn s-custom-primary ms-auto btn--md s-custom-btn--icon text-capitalize check-button btn <?= ($model->isNewRecord) ? 'check' : 'clear' ?>">
                                    ...
                                    <?php foreach ($modelTravellers as $i => $modelItem): ?>
                                        <div class="item panel panel-default"><!-- widgetBody -->
                                            <div class="panel-heading p-relative my-2">
                                                <h3 class="panel-title pull-left panel-title-birthday contact-us-page__label"><?=Yii::t('policy','Traveller <span class="index">{0}</span>',[$i+1])?></h3>
                                                <div class="pull-right page-footer-button">
                                ...
                                <div class="pull-right-page-footer-button">
                                    <button type="button" class="add-item <?= (count($modelTravellers) >= 6) ? 'd-none' : ''?> btn btn-success btn-xs s-custom-btn s-custom-primary s-custom-btn--icon mt-5 mb-5"><?=Yii::t('policy','Add traveller')?></button>
                                </div>
                                <?php DynamicFormWidget::end(); ?>
        ...
        <div class="col-lg-4 col-12">
            <div class="calculator-card p-relative">
                ...
                <div class="main-title-sm text-uppercase"><?= Yii::t('policy', 'Ҳисоблаш натижалари'); ?></div>
                ...
                <div class="contact-us-page__info">
                    ...
                    <div class="calculator-card__item policy_price-block">
                        ...
                        <div class="calculator-card__value">
                            ...
                            <span class="currency"><?= Yii::t('policy', 'UZS'); ?></span>

                        </div>
                        <div class="calculator-card__value small">
                            <span id="policy_price"><small><?= number_format($model->_policy_price_usd, 2, '.', ' ') ?></small></span>
                            <span class="currency"><small><?= Yii::t('policy', 'USD'); ?></small></span>
    ...
    <div class="flex-row">
            ...
            <div class="field modal__field">
                <div class="page-footer-button">
                    <div class="form-group">
                        ...
                        <?= Html::submitButton(Yii::t('policy','Apply'), ['class' => 'btn btn-success btn-xs s-custom-btn s-custom-primary s-custom-btn--icon mt-5 mb-5 btn btn-success submitForm', 'data-pjax' => false, 'disabled' => true]) ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <input type="hidden" id="url_post_pass_birthday" value="<?= Url::to(['/policy/travel/get-pass-birthday-data']) ?>">
    </div>
...
$jsPjax =<<<JS
                        ...
                        success: function (response)
                        {
                            ...
                            if (response.ERROR > 0) {
                                ...
                                if (driver_id == null) {
                                    ...
                                    $("button.check-traveller.check-"+param+"-index-"+driver_id).removeClass('check').addClass('clear');
    ...
    $(document).on('keyup', '.on-change-traveller-info', function(e) {
