...
<div class="policy-travel-search">
    ...
    <div class="form-group">
        <?= Html::submitButton(\app\widgets\BlocksWidget::widget(['slug' => 'Search']), ['class' => 'btn btn-primary']) ?>
        <?= Html::resetButton(\app\widgets\BlocksWidget::widget(['slug' => 'Reset']), ['class' => 'btn btn-default']) ?>
    </div>
