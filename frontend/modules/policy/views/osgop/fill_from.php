...
use frontend\modules\policy\assets\OsgopAsset;
...
OsgopAsset::register($this);

$this->title = !empty($modelPage->name) ? $modelPage->name : Yii::t('policy','Онлайн оформление полиса ОСГОП');
$this->params['breadcrumbs'][] = !empty($modelPage->name) ? $modelPage->name : Yii::t('policy','Онлайн оформление полиса ОСГОП');
