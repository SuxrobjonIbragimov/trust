...
<?php if (!empty($fileSize)) :?>
    <div class="single-blog files-item my-3 ">
        <div class="w-100 row m-0 align-items-center justify-content-between latest-news__bShadow-0818-8 bg-light br-18 border-primary-custom"
             data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="300" data-pjax="0">
            <div class="col-lg-8 col-md-7 col-sm-12 mt-lg-2 mt-md-2 mt-sm-4 mt-4">
                <div class="d-flex align-items-center flex-row">
                    <div class="flex-item-file">
                        <xml version="1.0" encoding="iso-8859-1">
                            <!--<svg class="d-none" fill="#FAB005" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="100px" height="100px">
                            ...
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                 ...
                                 viewBox="0 0 496 496" width="100px" height="100px"
...
<path style="fill:#0EE0B8;" d="M404,0H92C78.4,0,64,12.8,64,26.4v320L222.4,496H404c13.6,0,28-12.8,28-26.4V26.4
	C432,12.8,417.6,0,404,0z"/>
                                <path style="fill:#dfc482;" d="M404,0H92C78.4,0,64,12.8,64,26.4v320L222.4,496H404c13.6,0,28-12.8,28-26.4V26.4
	C432,12.8,417.6,0,404,0z"/>
                                <path style="fill:#d6b666;"
                                      d="M432,384V26.4C432,12.8,417.6,0,404,0H92C78.4,0,66.4,11.2,66.4,24"/>
                                <path style="fill:#b59136;" d="M432,384V26.4C432,12.8,417.6,0,404,0H208"/>
                                <path style="fill:#d6b666;"
                                      d="M200,352v119.2c0,1.6,1.6,3.2,1.6,4.8l19.2,18.4c1.6,0,3.2,1.6,4.8,1.6h125.6l-148-144H200z"/>
                                <path style="fill:#b59136;"
                                      d="M200,351.2v120c0,1.6,1.6,3.2,1.6,4.8l19.2,18.4c1.6,0,3.2,1.6,4.8,1.6h64l-72.8-120.8L200,351.2z"/>
                                <path style="fill:#eddeb9;"
                                      d="M222.4,496h1.6V370.4c0-13.6-12-26.4-25.6-26.4L64,345.6L222.4,496z"/>
                                <polyline style="fill:#426bbf;" points="64,345.6 222.4,496 224,496 224,368 "/>
                                <path style="fill:#19356e;"
                                      d="M80,345.6L80,345.6V26.4C80,12.8,89.6,0,102.4,0H92C78.4,0,64,12.8,64,26.4v320L80,345.6L80,345.6z"
                                /><!-- d6b666 --><!-- dfc482 --><!-- eddeb9 --><!-- 426bbf -->
                                <path style="fill:#426bbf;" d="M349.6,161.6L320,132c-6.4-6.4-15.2-10.4-24.8-10.4c-9.6,0-17.6,4-24.8,10.4L140,261.6
	...
	c0,0,0.8,0,0.8-0.8l86.4-86.4c6.4-6.4,10.4-15.2,10.4-24.8C359.2,176.8,356,168,349.6,161.6z"/>
                                <path style="fill:#19356e;" d="M349.6,139.2L320,109.6c-6.4-6.4-15.2-10.4-24.8-10.4c-9.6,0-17.6,4-24.8,10.4L140,240
	...
	c0,0,0.8,0,0.8-0.8l86.4-86.4c6.4-6.4,10.4-15.2,10.4-24.8C359.2,154.4,356,145.6,349.6,139.2z"/>
                    ...
                    <div class="section-file__box flex-item-file d-flex flex-column">
                        <div class="file-title-block">
                            <h4 class="section-file-title mx-2"><?= $model->title ?></h4>
                            <p class="section-latest-news__paragraf mx-2 mt-2 mb-2">
            ...
            <div class="file-link-block col-lg-4 col-md-5 col-sm-12 d-flex align-items-center mt-lg-0 mt-md-0 mt-sm-4 mt-4">
                <a href="<?= $url ?>" target="_blank"
                   class="btn btn-primary rounded-2 py-2 mb-lg-0 mb-md-0 mb-sm-4 mb-4 ms-lg-auto ms-md-auto ms-0" data-pjax="0">
                    <?= Yii::t('post', 'Посмотреть') ?>
                </a>
                <a href="<?= $url ?>" target="_blank" download
                   class="btn btn-primary rounded-2 py-2 mb-lg-0 mb-md-0 mb-sm-4 mb-4 ml-2 ms-lg-auto ms-md-auto ms-4"
                   data-pjax="0">
                    <?= Yii::t('post', 'Скачать ') ?>
                </a>
            </div>
