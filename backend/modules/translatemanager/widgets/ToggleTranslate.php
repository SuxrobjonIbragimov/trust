 ...
 *
 * ~~~
 * \backend\modules\translatemanager\widgets\ToggleTranslate::widget();
 * ~~~
 *
 ...
 * ~~~
 * \backend\modules\translatemanager\widgets\ToggleTranslate::widget([
 *  'position' => \backend\modules\translatemanager\widgets\ToggleTranslate::POSITION_TOP_RIGHT,
 * ]);
 * ~~~
 *
 ...
 * ~~~
 * \backend\modules\translatemanager\widgets\ToggleTranslate::widget([
 *  'frontendTranslationAsset' => 'backend\modules\translatemanager\assets\FrontendTranslationAsset',
 * ]);
 * ~~~
 *
...
class ToggleTranslate extends Widget
{
     ...
     */
    public $frontendTranslationAsset = 'backend\modules\translatemanager\assets\FrontendTranslationAsset';
     ...
     */
    public $frontendTranslationPluginAsset = 'backend\modules\translatemanager\assets\FrontendTranslationPluginAsset';
