...
class LanguageTranslate extends ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id'], 'integer'],
            [['id'], 'exist', 'targetClass' => '\backend\modules\translatemanager\models\LanguageSource'],
            [['language'], 'exist', 'targetClass' => '\backend\modules\translatemanager\models\Language', 'targetAttribute' => 'language_id'],
            [['translation'], 'string'],
