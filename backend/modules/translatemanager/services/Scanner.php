...
class Scanner
{
     ...
     */
    public $scanners = [
        '\backend\modules\translatemanager\services\scanners\ScannerPhpFunction',
        '\backend\modules\translatemanager\services\scanners\ScannerPhpArray',
        '\backend\modules\translatemanager\services\scanners\ScannerJavaScriptFunction',
        '\backend\modules\translatemanager\services\scanners\ScannerDatabase',
    ];
    ...
    public function run()
    {
        ...
        $scanTimeLimit = $module->scanTimeLimit;
