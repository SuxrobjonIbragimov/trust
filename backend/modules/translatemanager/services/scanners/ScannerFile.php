 ...
 *
 * ~~~
 * $genders = \backend\modules\translatemanager\helpers\Language::a($this->_GENDERS);
 * ~~~
 *
 * Translating to the language of your coice:
 *
 * ~~~
 * $statuses = \backend\modules\translatemanager\helpers\Language::a($this->_STATUSES, [], 'de-DE');
 * ~~~
 *
 */
abstract class ScannerFile extends MessageController
{
    ...
    /**
     * @inheritdoc Extracts messages from a file
