...
/**
 * This is the model class for table "{{%policy_travel_abroad_type}}".
 *
 * @property int $id
 ...
 */
class PolicyTravelAbroadType extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%policy_travel_abroad_type}}';
    }
    ...
    {
        return [
            [['ins_id', 'weight', 'status', 'created_at', 'updated_at'], 'default', 'value' => null],
            [['ins_id', 'weight', 'status', 'created_at', 'updated_at'], 'integer'],
    ...
    {
        return $this->hasMany(PolicyTravel::className(), ['abroad_type_id' => 'id']);
    }
