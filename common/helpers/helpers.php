...
define("LOCAL_DOMAIN_NAME", "trust.lc");

define("CAR_NUMBER_PATTERN_FIZ", "/[0-9]{2}[A-Za-z]{1}[0-9]{3}[A-Za-z]{2}/");

define("BASE_URL_INS", "http://api.ksc.uz/");
...
if (!function_exists('encrypt_decrypt')) {
    ...
    function encrypt_decrypt($string, $action = 'encrypt')
    {
        ...
        $secret_key = 'AA74CDCC2BBRT935136SHSB63C'; // user define private key !!! DO NoT CHANGE THIS KEY
        $secret_iv = '5fgf5HJ5spf'; // user define secret key !!! DO NoT CHANGE THIS IV
